...
|---|---|---|
| `documentary-engine-v1/documentary_engine/core.py` | `narrativecut/core.py` | deterministic asset catalog, timeline, assembly, QC |
| `documentary-engine-v1/documentary_engine/__main__.py` | `narrativecut/__main__.py` | local CLI |
| `documentary-engine-v1/documentary_engine/__init__.py` | `narrativecut/__init__.py` | package marker |
...
CLI does not require the donor project's private provider or channel configuration.
